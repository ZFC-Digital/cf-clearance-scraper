...
def get_source(source_url,method="source",url='http://127.0.0.1:3000/cf-clearance-scraper',authToken=None,proxy=None,callback=None,axios=None):
    data = {
            "url": source_url,
            "mode": method,
        }
...
callback = f'''
() => {{
    fetch("https://testnet.monad.xyz/api/claim", {{
        headers: {{
            'Accept': '*/*',
        ...
        referrer: "https://testnet.monad.xyz/",
...
print(callback)
get_source('http://testnet.monad.xyz/',callback=callback,proxy=proxy)